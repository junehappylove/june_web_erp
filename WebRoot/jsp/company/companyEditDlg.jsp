...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post">
			<fieldset>
				<legend>
					<img src="extend/fromedit.png" style="margin-bottom: -3px;" /> 公司编辑
				</legend>
				...
				<table>
					<tr>
						<th>公司名称</th>
						<td><input name="name" id="name" placeholder="请输入公司名称"
							class="easyui-textbox easyui-validatebox" type="text" /></td>
						<th>公司电话</th>
						<td><input name="tel" id="tel" type="text"
							class="easyui-textbox easyui-validatebox"
							data-options="required:true" /></td>
					</tr>
					<tr>
						<th>传真</th>
						<td><input name="fax" id="fax" type="text"
