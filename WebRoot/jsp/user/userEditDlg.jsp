...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post">
			<fieldset>
				<legend>
					<img src="extend/fromedit.png" style="margin-bottom: -3px;" /> 用户编辑
				</legend>
				<input name="userId" id="userId" type="hidden" /> <input
					name="created" id="created" type="hidden" /> <input name="creater"
					id="creater" type="hidden" /> <input name="status" id="status"
					type="hidden" /> <input name="organizeName" id="organizeName"
					type="hidden" />
				<table>
					<tr>
						<th>用户编码</th>
						<td><input name="myid" id="myid" placeholder="请输入用户编码"
							class="easyui-textbox easyui-validatebox" type="text" /></td>
						<th>用户账号</th>
						<td><input name="account"
							class="easyui-textbox easyui-validatebox" id="account"
							type="text" /></td>
					</tr>
					<tr>
						<th>用户名</th>
					...
					<tr>
						<th>组织部门</th>
						<td colspan="3"><input id="organizeId" name="organizeId"
