		...
		<div id="tt">
			<div title="基本资料" data-options="iconCls:'icon-cstbase'"
				...
				<fieldset>
					...
					<input name="itemId" id="itemId" type="hidden" /> <input
					...
					<table class="table">
						<tr>
							<th>货品名称</th>
							<td><input name="name" id="name" placeholder="请输入货品名称"
						...
						<tr>
							...
							<th>国际条码</th>
							<td><input name="barcode" id="barcode" type="text"
								class="easyui-textbox easyui-validatebox" /></td>
							<th>单位</th>
						...
						<tr>
							...
							<td><input id="cityId" name="cityId" type="text"
								class="easyui-textbox easyui-validatebox" /><input id="cityName"
								name="cityName" type="hidden" /><img src="extend/area.png"
							...
							<td><input id="weight" name="weight " type="text"
								class="easyui-textbox easyui-validatebox" /></td>
							<th>重量单位</th>
							<td><input id="maund" name="maund" type="text"
								class="easyui-textbox easyui-validatebox" /></td>
						</tr>
						<tr>
							<th>品牌</th>
							<td><input name="brandId" id="brandId" type="text"
								class="easyui-textbox easyui-validatebox" /><input
								name="brandName" id="brandName" type="hidden" /><img
								src="extend/area.png"
								style="margin-left: 2px; margin-bottom: -5px; cursor: pointer;"
								onclick="addBrandOpenDlg();" /></td>
							<th>税率</th>
							<td><input id="taxNo" name="taxNo" type="text"
								class="easyui-textbox easyui-validatebox" /></td>
						</tr>
						<tr>
							<th>备注</th>
			...
			<div title="包装资料" data-options="iconCls:'icon-help'"
				style="padding: 10px">
				<fieldset>
					...
					<table class="table">
						<tr>
							<th>包装单位</th>
							<td><input name="packageUnit" id="packageUnit"
								class="easyui-textbox easyui-validatebox" type="text" /></td>
							<th>换算率</th>
							<td><input name="converts" id="converts" type="text"
								class="easyui-textbox easyui-validatebox" /></td>
						</tr>
					</table>
				</fieldset>
			</div>
			<div title="库存参数" data-options="iconCls:'icon-help'"
				style="padding: 10px">
				<fieldset>
					...
					<table class="table">
						<tr>
							<th>批次管理</th>
							<td><select id="isBatch" class="easyui-combobox"
								name="isBatch" style="width: 171px;">
									<option value="Y">是</option>
									<option value="N">否</option>
							</select></td>
							<th>有效期管理</th>
							<td><select id="isValid" class="easyui-combobox"
								name="isValid" style="width: 171px;">
									<option value="Y">是</option>
									<option value="N">否</option>
							</select></td>
						</tr>
			...
			<div title="价格资料" data-options="iconCls:'icon-help'"
				style="padding: 10px">
				<fieldset>
					...
					<table class="table">
						<tr>
							<th>成本价</th>
							<td><input name="cost" id="cost"
								class="easyui-textbox easyui-validatebox" type="text" /></td>
							<th>零售价</th>
							<td><input name="retailPrice" id="retailPrice" type="text"
								class="easyui-textbox easyui-validatebox" /></td>
						</tr>
					</table>
				</fieldset>
			</div>
			<div title="货品图片" data-options="iconCls:'icon-help'"
				style="padding: 10px">
				<fieldset>
