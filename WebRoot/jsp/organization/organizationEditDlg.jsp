...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post">
			<fieldset>
				<legend>
					<img src="extend/fromedit.png" style="margin-bottom: -3px;" /> 组织编辑
				</legend>
				<input name="organizationId" id="organizationId" type="hidden" /> <input
				...
				<table>
					<tr>
						...
						<td><input name="fullName" id="fullName"
							placeholder="请输入组织名称" class="easyui-textbox easyui-validatebox"
					...
					<tr>
						<th>英文名称</th>
						<td><input name="ename" id="ename" type="text"
					...
					<tr>
						...
						<td><input id="pid" name="pid" type="text"
							class="easyui-textbox easyui-validatebox" /></td>
						<th>组织图标</th>
						<td><input id=iconCls name="iconCls" type="text"
					...
					<tr>
						...
						<td colspan="3"><textarea class="easyui-textbox"
								name="description" style="width: 420px; height: 100px;"></textarea></td>
					</tr>
				</table>
			</fieldset>
		</form>
