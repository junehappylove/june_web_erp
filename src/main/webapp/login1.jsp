<%@ page language="java" import="java.util.*,com.erp.util.*"
	pageEncoding="UTF-8"%>
<%
...
<link rel="stylesheet" type="text/css"
	href="themes/<%=easyuiThemeName %>/easyui.css"></link>
...
<body
	style="background-image: url('extend/log_bg.gif'); background-repeat: repeat-x;">
	...
	<div align="center">
		...
		<div
			style="margin-top: 37px; height: 185px; width: 372px; background-image: url('extend/log_con_bg.gif');">
				...
				<div style="margin-top: 15px;">
					<div style="width: 213px;" align="left">
						<a id="submitForm" href="javascript:void(0)"
							onclick="submitForm();" class="easyui-linkbutton">登 录</a> <span
							style="margin-left: 10px;"></span> <a id="clearForm"
							href="javascript:void(0)" class="easyui-linkbutton">重 置</a>
					</div>
					<div align="right"
						style="float: right; margin-top: -24px; margin-right: 28px;">
						<a id="rollBack" class="easyui-linkbutton"
							data-options="toggle:true" href="javascript:void(0)">数据库初始化</a>
					</div>
				</div>
			</form>
		</div>
