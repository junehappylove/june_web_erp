			...
			<div id="tt">
				<div title="基本资料" data-options="iconCls:'icon-cstbase'"
					...
					<fieldset>
						...
						<input name="suplierId" id="suplierId" type="hidden" /> <input
						...
						<table class="table">
							<tr>
								<th>供应商名称</th>
								<td><input name="name" id="name" placeholder="请输入供应商名称"
							...
							<tr>
								...
								<th>采购代表</th>
								<td><input name="buyerId" id="buyerId" type="text"
									class="easyui-textbox easyui-validatebox" /><input
									name="buyerName" id="buyerName" type="hidden" /></td>
								<th>公司法人</th>
						...
						<table class="table">
							...
							<tr>
								...
								<td><input id="totalSales" name="totalSales" type="text"
									class="easyui-textbox easyui-validatebox" /></td>
								<th>交易状态</th>
								<td><select id="suplierStatus" class="easyui-combobox"
									name="suplierStatus" style="width: 171px;">
