				...
				<tr>
					<td style="padding-left: 2px"><shiro:hasPermission
							...
							<a href="javascript:void(0);" class="easyui-linkbutton"
								iconCls="icon-time" plain="true" onclick="addRowsOpenDlg();">定时备份</a>
						</shiro:hasPermission> <shiro:hasPermission name="dbBackUpTime">
							<a href="javascript:void(0);" class="easyui-linkbutton"
								iconCls="icon-auto" plain="true" onclick="updRowsOpenDlg();">手动备份</a>
