...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<form id="form" method="post">
			<fieldset>
				<legend>
					<img src="extend/fromedit.png" style="margin-bottom: -3px;" /> 程式编辑
				</legend>
				<input name="permissionId" id="permissionId" type="hidden" /> <input
					name="created" id="created" type="hidden" /> <input name="creater"
					id="creater" type="hidden" /> <input name="status" id="status"
					type="hidden" /> <input name="state" id="state" type="hidden" />
				<table>
					<tr>
						<th>程式名称</th>
						<td><input name="name" id="name" placeholder="请输入程式名称"
							class="easyui-textbox easyui-validatebox" type="text" /></td>
						<th>父程式名称</th>
						<td><input name="pid" class="easyui-textbox" id="pid"
							type="text" /><input name="pname" id="pname" type="hidden" /></td>
					...
					<tr>
						...
						<td><input id="url" name="url" type="text"
							class="easyui-textbox easyui-validatebox" required="required" /></td>
						<th>程式编码</th>
						<td><input id="myid" name="myid" type="text"
							class="easyui-textbox easyui-validatebox" required="required" /></td>
					</tr>
					<tr>
						<th>程式类型</th>
					...
					<tr>
						...
						<td colspan="3"><textarea class="easyui-textbox"
								name="description" style="width: 435px; height: 100px;"></textarea></td>
					</tr>
				</table>
			</fieldset>
		</form>
