		...
		<form id="form" method="post">
			<fieldset>
				...
				<table>
					<tr>
						<th>日志名称</th>
						<td><input name="name" id="name" placeholder="请输入日志名称"
					...
					<tr>
						<th>操作名称</th>
						<td><input name="eventName" id="eventName" type="text"
					...
					<tr>
						...
						<td colspan="3"><textarea class="easyui-textbox"
								name="eventRecord" style="width: 420px; height: 100px;"></textarea></td>
					</tr>
				</table>
			</fieldset>
		</form>
