...
<div class="easyui-layout" data-options="fit:true,border:false">
	<div data-options="region:'center',border:false" title=""
		...
		<input name="tempId" id="tempId" type="hidden"
			value="<%= request.getParameter("tempId")%>" />
		<form id="form" method="post">
			<fieldset>
				<legend>
					<img src="extend/fromedit.png" style="margin-bottom: -3px;" /> 词典编辑
				</legend>
				<input name="codeId" id="codeId" type="hidden" /> <input
					name="created" id="created" type="hidden" /> <input name="creater"
					id="creater" type="hidden" /> <input name="status" id="status"
					type="hidden" /> <input name="state" id="state" type="hidden" /> <input
					name="permissionName" id="permissionName" type="hidden" /> <input
					name="codePid" id="codePid" type="hidden" />
				<table>
					<tr>
						<th>词典名称</th>
						<td><input name="name" id="name" placeholder="请输入词典名称"
							class="easyui-textbox easyui-validatebox" type="text" /></td>
						<th>父项模块</th>
						<td><input id="permissionId" name="permissionId"
					...
					<tr>
						...
						<td><input id="parentId" name="parentId"
							class="easyui-textbox" type="text" /></td>
						<th>词典编码</th>
						<td><input id="codeMyid" name="codeMyid" type="text"
							class="easyui-textbox easyui-validatebox" /></td>
					</tr>
					<tr>
						<th>词典图标</th>
						<td><input id="iconCls" name="iconCls" class="easyui-textbox"
							type="text" /></td>
						<th>排序编码</th>
						<td><input name="sort" id="sort" type="text"
							class="easyui-textbox easyui-validatebox" /></td>
					</tr>
					<tr>
						<th>描述</th>
						<td colspan="3"><textarea class="easyui-textbox"
								name="description" style="width: 415px; height: 100px;"></textarea></td>
					</tr>
				</table>
			</fieldset>
		</form>
