...
public class Organization implements java.io.Serializable {
	...
	/** full constructor */
	public Organization(Integer companyId, String myid, Integer pid, String fullName, String ename, Integer manager,
			String iconCls, Integer assistantManager, Integer empQty, String status, Date created, Date lastmod,
			String shortName, String tel, String fax, String description, Integer creater, Integer modifyer,
			String state) {
