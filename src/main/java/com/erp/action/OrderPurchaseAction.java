...
public class OrderPurchaseAction extends BaseAction implements ModelDriven<OrderPurchase> {
	 ...
	 * 查询采购单明细 @param @return @param @throws Exception 设定文件 @return String
	 * 返回类型 @throws
	 */
	 ...
	 * 持久化采购单 @param @return @param @throws Exception 设定文件 @return String
	 * 返回类型 @throws
	 */
	public String persistenceOrderPurchase() throws Exception {
		...
		OutputJson(getMessage(orderPurchaseService.persistenceOrderPurchase(getModel(), map)),
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-1修改日期 修改内容 @Title:
	 * delOrderPurchase @Description: 删除采购单 @param @return @param @throws
