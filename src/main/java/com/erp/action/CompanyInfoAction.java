...
public class CompanyInfoAction extends BaseAction implements ModelDriven<CompanyInfo> {
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-4-28修改日期 修改内容 @Title:
	 * persistenceCompanyInfo @Description:
	 * 持久化persistenceCompanyInfo @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	public String persistenceCompanyInfo() throws Exception {
		System.out.println(inserted);
		// String
		// sdfString="[{"name":"123123","tel":"123","fax":"123","address":"123","zip":"123","email":"123123@qq.com","contact":"123","description":"123123"}]";
	...
	/**
	 * 函数功能说明 CompanyInfo弹出框模式新增 Administrator修改者名字 2013-6-9修改日期
	 * 修改内容 @Title: addCompanyInfo @Description: @param @return @param @throws
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-4-28修改日期 修改内容 @Title:
	 * findAllCompanyInfoList @Description:
	 * 查询所有或符合条件的CompanyInfo @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 删除CompanyInfo Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
	 * delCompanyInfo @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
