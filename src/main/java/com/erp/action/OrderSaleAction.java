...
public class OrderSaleAction extends BaseAction implements ModelDriven<OrderSale> {
	 ...
	 * 查询客户订单明细 @param @return @param @throws Exception 设定文件 @return String
	 * 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-8修改日期 修改内容 @Title:
	 * findOrderSaleList @Description: 查询客户订单 @param @return @param @throws
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-8修改日期 修改内容 @Title:
	 * persistenceOrderSale @Description:
	 * 持久化客户订单 @param @return @param @throws Exception 设定文件 @return String
	 * 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-8修改日期 修改内容 @Title:
	 * delOrderSale @Description: 删除客户订单 @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
