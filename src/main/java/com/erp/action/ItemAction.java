...
public class ItemAction extends BaseAction implements ModelDriven<Item> {
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-2修改日期 修改内容 @Title:
	 * findItemByMyid @Description:
	 * 根据myid查询商品 @param @return @param @throws Exception 设定文件 @return
	 * String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-27修改日期 修改内容 @Title:
	 * findBrandList @Description: 查询品牌 @param @return @param @throws
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-27修改日期 修改内容 @Title:
	 * addBrands @Description: 增加品牌 @param @return @param @throws Exception
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-27修改日期 修改内容 @Title:
	 * findItemList @Description: 查询商品列表 @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-27修改日期 修改内容 @Title:
	 * persistenceItem @Description: 持久化item @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-27修改日期 修改内容 @Title:
	 * delItem @Description: 删除ITem @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
