...
public class CstAction extends BaseAction implements ModelDriven<Customer> {
	 ...
	 * findCustomerList @Description: 查询所有客户 @param @return @param @throws
	 ...
	 * 查询所有客户不分页 @param @return @param @throws Exception 设定文件 @return
	 * String 返回类型 @throws
	 */
	 ...
	 * 持久化Customer @param @return @param @throws Exception 设定文件 @return
	 * String 返回类型 @throws
	 */
	 ...
	 * delCustomer @Description: 删除客户 @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 获取所有销售代表 Administrator修改者名字 2013-6-24修改日期 修改内容 @Title:
