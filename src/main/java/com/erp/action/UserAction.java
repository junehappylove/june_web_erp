...
public class UserAction extends BaseAction implements ModelDriven<Users> {
	...
	/**
	 * 函数功能说明 查询所有用户 Administrator修改者名字 2013-5-29修改日期 修改内容 @Title:
	 * findAllUserList @Description: @param @return @param @throws Exception
	...
	/**
	 * 函数功能说明 持久化用户 Administrator修改者名字 2013-5-29修改日期 修改内容 @Title:
	 * persistenceUsers @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 持久化用户弹窗模式 Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
	 * persistenceUsersDig @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 删除users Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
	 * delUsers @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 查询用户拥有角色 Administrator修改者名字 2013-5-29修改日期 修改内容 @Title:
	 * findUsersRolesList @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 保存用户分配的角色 Administrator修改者名字 2013-5-29修改日期 修改内容 @Title:
	 * saveUserRoles @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
