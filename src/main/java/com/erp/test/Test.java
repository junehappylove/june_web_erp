...
public class Test {
	public static void main(String[] orgs) {
		...
		/*
		 * try { //String param=Test.getCityId(); String
		 * urlStr="http://m.weather.com.cn/data/101190401.html"; URL url=new
		 * URL(urlStr); HttpURLConnection
		 * conn=(HttpURLConnection)url.openConnection(); conn.connect();
		 * InputStreamReader r=new
		 * InputStreamReader(conn.getInputStream(),"UTF-8"); BufferedReader
		 * rd=new BufferedReader(r); String line; String str="";
		 * while((line=rd.readLine())!=null){
		 * if(line!=null&&(!line.equals(""))){ //System.out.println(line);
		 * str=line; } } conn.disconnect(); r.close(); rd.close();
