...
public class SupServiceImpl implements SupService {
	...
	/*
	 * (非 Javadoc) <p>Title: findSuplierContactList</p> <p>Description:查询供应商联系人
	 * </p>
	 * 
	 * @param SuplierId
	 * 
	 ...
	 * @return
	 * 
	 * @see com.erp.service.SupService#getCount(java.util.Map,
	 * com.erp.util.PageUtil)
	 */
	...
	/*
	 * (非 Javadoc) <p>Title: persistenceSuplier</p> <p>Description:
	 * 持久化Suplier和持久化关联的 SuplierContact</p>
	 * 
	 * @param c
	 * 
	 * @param map
	 ...
	 * @return
	 * 
	 * @see com.erp.service.SupService#persistenceSuplier(com.erp.model.Suplier,
	 * java.util.Map)
	 */
