...
public class DbBackUpServiceImpl implements DbBackUpService {
	private static final Logger logger = Logger.getLogger(DbBackUpServiceImpl.class);
	 ...
	 * @return
	 * 
	 * @see com.erp.service.DbBackUpService#findLogsAllList(java.util.Map,
	 ...
	 * @return
	 * 
	 * @see com.erp.service.DbBackUpService#getCount(java.util.Map,
	 * com.erp.util.PageUtil)
	 */
	 ...
	 * @return
	 * 
	 * @see com.erp.service.DbBackUpService#addLog(java.lang.String,
