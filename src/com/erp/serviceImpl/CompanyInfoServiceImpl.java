...
public class CompanyInfoServiceImpl implements CompanyInfoService {
	...
	/*
	 * (非 Javadoc) <p>Title: persistenceCompanyInfo</p> <p>Description:
	 * 持久化CompanyInfo</p>
	 * 
	 * @param map
	 * 
	 ...
	 * 
	 * @see
	 * com.erp.service.CompanyInfoService#persistenceCompanyInfo(java.util.Map)
	 */
	...
	/*
	 * (非 Javadoc) <p>Title: findAllCompanyInfoList</p> <p>Description:
	 * 查询所有CompanyInfo</p>
	 * 
	 * @param param
	 * 
	 ...
	 * 
	 * @see
	 * com.erp.service.CompanyInfoService#findAllCompanyInfoList(java.util.Map,
	...
	/*
	 * (非 Javadoc) <p>Title: getCount</p> <p>Description:查询条数 </p>
	 * 
	 * @param param
	 * 
	 * @return
