...
public class SystemCodeServiceImpl implements SystemCodeService {
	...
	/*
	 * (非 Javadoc) <p>Title: findSystemCodeList</p> <p>Description: </p>
	 * 
	 * @param id
	 * 
	 * @return
	 * 
	 * @see
	 * com.erp.service.SystemCodeService#findSystemCodeList(java.lang.Integer)
	 */
	...
	/*
	 * (非 Javadoc) <p>Title: persistenceSystemCodeDig</p> <p>Description: </p>
	 * 
	 * @param systemCode
	 * 
	 * @return
	 * 
	 * @see
	 * com.erp.service.SystemCodeService#persistenceSystemCodeDig(com.erp.model.
	 * SystemCode)
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-20修改日期 修改内容 @Title:
	 * isExtPermissionId @Description: 检查模块是否存在 @param @param
	 * permissionId @param @return 设定文件 @return boolean 返回类型 @throws
	 */
	...
	/*
	 * (非 Javadoc) <p>Title: findSystemCodeByType</p> <p>Description: </p>
	 * 
	 * @param codeMyid
	 * 
	 * @return
	 * 
	 * @see
	 * com.erp.service.SystemCodeService#findSystemCodeByType(java.lang.String)
	 */
	...
	/*
	 * (非 Javadoc) <p>Title: delSystemCode</p> <p>Description: </p>
	 * 
	 * @param codeId
	 * 
	 * @return
