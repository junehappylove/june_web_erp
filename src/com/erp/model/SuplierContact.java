...
public class SuplierContact implements java.io.Serializable {
	...
	/** full constructor */
	public SuplierContact(Integer classId, String name, Integer sexId, String className, String sexName,
			String organization, String duty, String tel, String email, String mobile, String description,
			String status, Date created, Date lastmod, Integer creater, Integer modifyer, String qq) {
		this.classId = classId;
		this.name = name;
		this.sexId = sexId;
