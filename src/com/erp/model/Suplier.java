...
public class Suplier implements java.io.Serializable {
	...
	/** full constructor */
	public Suplier(String name, String myid, String status, Date created, Date lastmod, Integer creater,
			...
			String zip, Integer levelId, String levelName, Integer sourceId, String sourceName, Integer natureId,
			String natureName, Integer industryId, String industryName, String mainBusiness, Integer sizeId,
			String sizeName, Date setupDate, Integer capital, String corporation, Integer creditId, String creditName,
			String bank, String account, String taxno, String shared, Integer pid, Integer attachmentId,
			String description, Integer buyerId, String buyerName, Integer buyerOrganizationId,
			String buyerOrganizationName, String suplierStatus, String className, Integer empCount, String totalSales,
			Integer currencyId, String currencyName, String deductionTax, Integer tax) {
		this.name = name;
		this.myid = myid;
		this.status = status;
		this.created = created;
