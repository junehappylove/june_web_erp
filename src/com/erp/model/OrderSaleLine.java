...
public class OrderSaleLine implements java.io.Serializable {
	...
	/** full constructor */
	public OrderSaleLine(Integer orderSaleId, Integer itemId, String myid, String itemName, String spec, String unit,
			Integer brandId, String brandName, Integer orderQty, String description, Date created, Date lastmod,
			String status, Integer creater, Integer modifyer, Double price, Double tax, Double priceTax, Double amount,
