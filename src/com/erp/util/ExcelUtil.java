...
public class ExcelUtil<T> {
	 ...
	 * importExcel @Description: excel导入 @param @param
	 * sheetName @param @param input @param @return 设定文件 @return List
	 * <T> 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-28修改日期 修改内容 @Title:
	 * exportExcel @Description: 导出excel @param @param list @param @param
	 * sheetName @param @param sheetSize @param @param output @param @return
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-28修改日期 修改内容 @Title:
	 * getExcelCol @Description: 获取excel转化到数字 A->1 B->2 @param @param
	 * col @param @return 设定文件 @return int 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-28修改日期 修改内容 @Title:
	 * setHSSFPrompt @Description: 设置提示信息 @param @param sheet @param @param
	 * promptTitle @param @param promptContent @param @param
	 * firstRow @param @param endRow @param @param firstCol @param @param
	 * endCol @param @return 设定文件 @return HSSFSheet 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-28修改日期 修改内容 @Title:
	 * setHSSFValidation @Description: 设置验证行数据 @param @param
	 * sheet @param @param textlist @param @param firstRow @param @param
	 * endRow @param @param firstCol @param @param endCol @param @return
	 * 设定文件 @return HSSFSheet 返回类型 @throws
	 */
