...
public class FunctionAction extends BaseAction implements ModelDriven<Permission> {
	...
	/**
	 * 函数功能说明 持久化程式实体 Administrator修改者名字 2013-5-10修改日期 修改内容 @Title:
	...
	/**
	 * 函数功能说明 弹出框编辑function Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
	 * persistenceFunctionDig @Description: @param @return @param @throws
	...
	/**
	 * 函数功能说明 删除程式 Administrator修改者名字 2013-5-10修改日期 修改内容 @Title:
	...
	/**
	 * 函数功能说明 查询所有程式 Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
	 * findAllFunctionLists @Description: @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
