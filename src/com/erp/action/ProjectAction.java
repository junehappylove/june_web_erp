...
public class ProjectAction extends BaseAction implements ModelDriven<Project> {
	 ...
	 * findCustomers @Description: 查询所有客户 @param @return @param @throws
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-27修改日期 修改内容 @Title:
	 * findProjectFollowsList @Description:
	 * 查询项目记录 @param @return @param @throws Exception 设定文件 @return String
	 * 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-27修改日期 修改内容 @Title:
	 * findCustomerList @Description: 查询所有项目 @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	 ...
	 * findProjectListCombobox @Description:
	 * 查询所有项目下拉框格式 @param @return @param @throws Exception 设定文件 @return
	 * String 返回类型 @throws
	 */
	 ...
	 * 持久化persistenceProject @param @return @param @throws Exception
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-27修改日期 修改内容 @Title:
	 * delProject @Description: 删除Project @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
