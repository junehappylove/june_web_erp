...
public class PermissionAssignmentAction extends BaseAction implements ModelDriven<Role> {
	...
	/**
	 * 函数功能说明 按节点查询所有程式 Administrator修改者名字 2013-5-10修改日期 修改内容 @Title:
	...
	/**
	 * 函数功能说明 查询所有角色 Administrator修改者名字 2013-5-20修改日期 修改内容 @Title:
	 * findAllRoleList @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 查询所有角色不分页 Administrator修改者名字 2013-5-29修改日期 修改内容 @Title:
	 * findAllRoleListNotPage @Description: @param @return @param @throws
	...
	/**
	 * 函数功能说明 有roleId获取角色权限 Administrator修改者名字 2013-5-29修改日期 修改内容 @Title:
	 * getRolePermission @Description:  @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 保存角色权限 Administrator修改者名字 2013-5-29修改日期 修改内容 @Title:
	 * savePermission @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 持久化角色 Administrator修改者名字 2013-5-29修改日期 修改内容 @Title:
	 * persistenceRole @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 弹窗持久化角色 Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
	 * persistenceRoleDlg @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
