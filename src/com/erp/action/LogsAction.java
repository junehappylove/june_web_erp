...
public class LogsAction extends BaseAction implements ModelDriven<Log> {
	...
	/**
	 * 函数功能说明 查询所有日志 Administrator修改者名字 2013-6-18修改日期 修改内容 @Title:
	 * findLogsAllList @Description: @param @return @param @throws Exception
	...
	/**
	 * 函数功能说明 持久化日志弹窗 Administrator修改者名字 2013-6-18修改日期 修改内容 @Title:
	 * persistenceLogs @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 删除日志 Administrator修改者名字 2013-6-18修改日期 修改内容 @Title:
	 * delLogs @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
