...
public class DbBackUpAction extends BaseAction implements ModelDriven<BackupScheduleConfig> {
	 ...
	 * findDbBackUpAllList @Description:
	 * 数据库备份 @param @return @param @throws Exception 设定文件 @return String
	 * 返回类型 @throws
	 */
	 ...
	 * getScheduleConfig @Description: 获取调度配置 @param @return @param @throws
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-11修改日期 修改内容 @Title:
	 * handSchedule @Description: 手动备份方法 @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-11修改日期 修改内容 @Title:
	 * checkBackUp @Description: 检查备份文件是否存在
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-11修改日期 修改内容 @Title:
	 * downBackUpFile @Description: 下载备份文件 @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-10修改日期 修改内容 @Title:
	 * schedule @Description: 定时任务启动 @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
