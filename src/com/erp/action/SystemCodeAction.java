...
public class SystemCodeAction extends BaseAction implements ModelDriven<SystemCode> {
	...
	/**
	 * 函数功能说明 按节点查询所有词典 Administrator修改者名字 2013-6-19修改日期 修改内容 @Title:
	 * findSystemCodeList @Description: @param @return @param @throws Exception
	...
	/**
	 * 函数功能说明 查询所有词典 Administrator修改者名字 2013-6-19修改日期 修改内容 @Title:
	 * findAllSystemCodeList @Description: @param @return @param @throws
	...
	/**
	 * 函数功能说明 弹窗持久化systemCode Administrator修改者名字 2013-6-19修改日期 修改内容 @Title:
	 * persistenceSystemCodeDig @Description: @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	public String persistenceSystemCodeDig() throws Exception {
		OutputJson(getMessage(systemCodeService.persistenceSystemCodeDig(getModel(), permissionName, codePid)),
				Constants.TEXT_TYPE_PLAIN);
		return null;
	}

	/**
	 * 函数功能说明 删除词典 Administrator修改者名字 2013-6-19修改日期 修改内容 @Title:
	 * delSystemCode @Description: @param @return @param @throws Exception
	 * 设定文件 @return String 返回类型 @throws
	 */
	 ...
	 * findSystemCodeByType @Description:
	 * 查询词典的公用方法 @param @return @param @throws Exception 设定文件 @return
	 * String 返回类型 @throws
	 */
