...
public class SupAction extends BaseAction implements ModelDriven<Suplier> {
	 ...
	 * findSuplierContactList @Description:
	 * 查询供应商联系人 @param @return @param @throws Exception 设定文件 @return String
	 * 返回类型 @throws
	 */
	 ...
	 * findSuplierContactListCombobox @Description:
	 * 查询供应商联系人下拉框格式 @param @return @param @throws Exception 设定文件 @return
	 * String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-26修改日期 修改内容 @Title:
	 * findSuplierList @Description: 查询所有客户列表 @param @return @param @throws
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-7-1修改日期 修改内容 @Title:
	 * findSuplierListNoPage @Description:
	 * 无分页查询所有供应商 @param @return @param @throws Exception 设定文件 @return
	 * String 返回类型 @throws
	 */
	 ...
	 * persistenceSuplier @Description:
	 * 持久化Suplier @param @return @param @throws Exception 设定文件 @return
	 * String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 Administrator修改者名字 2013-6-26修改日期 修改内容 @Title:
	 * delSuplier @Description: 删除Suplier @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
