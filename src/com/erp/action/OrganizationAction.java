...
public class OrganizationAction extends BaseAction implements ModelDriven<Organization> {
	...
	/**
	 * 函数功能说明 查询所有组织 Administrator修改者名字 2013-5-29修改日期 修改内容
	 * 
	...
	/**
	 * 函数功能说明 按节点查询所有组织 Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
	...
	/**
	 * 函数功能说明 持久化组织 Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
	 * persistenceOrganization @Description: @param @return @param @throws
	 * Exception 设定文件 @return String 返回类型 @throws
	 */
	...
	/**
	 * 函数功能说明 删除Organization Administrator修改者名字 2013-6-14修改日期 修改内容 @Title:
